...
const Breadcrumb = () => {
  return (
    <div className='elementor flex relative ml-auto mr-auto h-64 '>
     ...
     after:absolute after:w-full after:h-full after:top-0 after:left-0 after:-z-[1] after:bg-[#191a1bbb] bg-center bg-cover bg-no-repeat py-20'>
      <div className='max-w-[1200px] mx-auto px-4 w-full'>
          <div className='flex justify-center flex-wrap'>
              <div className='w-2/3'>
                <div className='relative px-4 w-full'>
                  <div className="breadcrumbs-content text-center">
                    <h1 className='text-white font-semibold md:text-[60px] text-[32px] mb-3'>Contact Us</h1>
                    <ul className="breadcrumb-menu">
                      ...
                      <li className='inline-block uppercase'><span className='text-[#ff4545]'>Contact Us</span></li>
                    </ul>
                  </div>
              </div>
                </div>
