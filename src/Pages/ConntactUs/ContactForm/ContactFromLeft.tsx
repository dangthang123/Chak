                ...
                <div className="contact-info-list px-0 py-12">
                    <div className=" mb-7 relative pl-20 ">
                        ...
                        <div className="content">
                            <h5 className="mb-3 text-[18px] font-semibold text-[#111111]">Main Address</h5>
                    ...
                    <div className=" mb-7 relative pl-20 ">
                        ...
                        text-[25px]"></i>
                        <div className="content">
                            <h5 className="mb-3 text-[18px] font-semibold text-[#111111]">Email Address</h5>
                    ...
                    <div className=" mb-7 relative pl-20 ">
                        ...
                        text-[25px]"></i>
                        <div className="content">
                            <h5 className="mb-3 text-[18px] font-semibold text-[#111111]">Phone number</h5>
                            <p className="text-[#646a7c] text-[18px] leading-7">
                                +012 (345) 78967
                                <br />
                                +010 (345) 78967
